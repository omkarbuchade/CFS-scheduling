...
Timer::SetInterrupt() 
{
    if (!disable) {
       ...
       //The following interrupt is disabled since we no longer need it for CFS scheduling
       //The only interrupt is in scheduler.cc file which will be triggered at the end of each time slice
