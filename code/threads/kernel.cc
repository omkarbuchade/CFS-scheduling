...
int SortMethod(ioRequest *r1, ioRequest *r2)
{
    if(r1->getexecStart_time()<r2->getexecStart_time())
        return -1;
    else if(r1->getexecStart_time()>r2->getexecStart_time())
        return 1;
    else
        return 0;
}
...
Kernel::Initialize()
{
    ...
    reqList=new SortedList <ioRequest *>(SortMethod);
