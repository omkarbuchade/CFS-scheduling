...
//This constructor is invoked for CPU, IO and hybrid bound threads
...
Thread::Yield ()
{
    ...
    this->setFinish(kernel->stats->totalTicks);
...
//  void Thread::setRunTime(int t)
//  {
//      vRunTime = t;
//  }
// int Thread::getRunTime()
// {
//     return vRunTime;
// }

void Thread::setStart(int t)
 {
     start = t;
 }
int Thread::getStart()
{
 ...
 void Thread::setFinish(int t)
 {
     finish = t;
 }
int Thread::getFinish()
{
    return finish;
}

 void Thread::setExecution_time()
 {
     execution_time = execution_time+(finish-start);
 }
int Thread::getExecution_time()
{
    return execution_time;
}

void Thread::setWait(int t)
{
    wait=t;
}
